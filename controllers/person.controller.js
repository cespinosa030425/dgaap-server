...
const getAllPerson = async (req, res) => {
     try {
          const persons = await personModel.findAll({
             attributes:[[sequelizeDB.fn('concat', sequelizeDB.col('firstName'),' ', sequelizeDB.col('lastName')),"fullName"],'firstName','lastName','personId','birthdayDate', 'position', 'photo','career', 'reportsTo','startedOn','departamentId','email','phoneNumber','celNumber','healthInsurance','isActive'],
               // where: {
               //      isActive: true
               // },
               include: {
